...
const ExperiencesTimeline = () => {
    return (
        <div className="sm:py-10 py-5 px-5 flex flex-col">
            <h1 className="font-semibold sm:text-3xl flex sm:mb-10 mb-5 justify-center text-2xl">
                My Experience
            </h1>
            {experience.map(item => (
                <div className="relative flex sm:grid grid-cols-3">
                    <div className="grid justify-end absolute sm:relative bottom-0 right-0 sm:mr-6 font-semibold mt-1 ">
                        {item.from} - {item.to}
                    </div>
